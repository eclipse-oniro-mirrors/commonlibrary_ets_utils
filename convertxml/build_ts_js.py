...
if __name__ == '__main__':
    ...
    if os.access("../../../../out/ohos-arm64-release", os.F_OK):
        os.system('cp -r ./out/js_convertxml.js ../../../../out/ohos-arm64-release/obj/base/compileruntime/js_api_module/convertxml/js_convertxml.js')
        
    if os.access("../../../../out/ohos-arm-release", os.F_OK):
        os.system('cp -r ./out/js_convertxml.js ../../../../out/ohos-arm-release/obj/base/compileruntime/js_api_module/convertxml/js_convertxml.js')
