...
HWTEST_F(NativeEngineTest, ConstructorTest001, testing::ext::TestSize.Level0)
{
    ...
    OHOS::Uri::Uri uri(env, "http://username:password@www.baidu.com:99/path/path?query#fagment");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[1080::8:800:200C:417A]:99/path/66path1?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[::]:88/path/path66?foooo#gaogao");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[1:0:0:1:2:1:2:1]:99/path/66path1?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[::FFFF:129.144.52.38]:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[::192.9.5.5]:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[22::22:2:2%ss]:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@[fe80::0001:0000]:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://username:password@199.98.55.44:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://16.9.5.4:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://[::168:169:333]:99/path/path?query#fagment");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://user@49.10hh8.54.12:80/path/path?query#qwer");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://user@www.baidu.com/path/path?query#qwer");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "ftp://user@www.1hw.1com:77/path/path?query#qwer");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://user@hosthost/path/path?query#qwer");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://user@[::]/path/path?query#qwer");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://[::192:0:5]/path/path?query#qwer");
    ASSERT_STREQ(uri.GetScheme().c_str(), "http");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/path1?query#fagment");
...
HWTEST_F(NativeEngineTest, EqualsTest002, testing::ext::TestSize.Level0)
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/path1?query#fagment");
    OHOS::Uri::Uri uri1(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/path1?query#fagment");
    ASSERT_TRUE(uri.Equals(uri1));
}
...
HWTEST_F(NativeEngineTest, EqualsTest003, testing::ext::TestSize.Level0)
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/path1?query#fagment");
    OHOS::Uri::Uri uri1(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/path1?query#fagment123");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://user@[1:0:0:1:2:1:2:1]:99/path/66./../././mm/.././path1?query#fagment");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/../../path?query#fagment");
    std::string normalize = uri.Normalize();
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/../../path/.././../aa/bb/cc?query#fagment");
    std::string normalize = uri.Normalize();
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "http://gg:gaogao@[1:0:0:1:2:1:2:1]:99/aa/bb/cc?query#fagment");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "htt1p://gg:gaogao@[::192.9.5.5]:99/path/66path1?query#fagment");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "ftp://username:www.baidu.com/path?query#fagment");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "f/tp://username:password@www.baidu.com:88/path?query#fagment");
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "ftp://username:password@www.baidu.com:88/path?query#fagment");
    bool res = uri.IsAbsolute();
    ASSERT_TRUE(res);
}
...
{
    napi_env env = (napi_env)engine_;
    OHOS::Uri::Uri uri(env, "htt/p://username:password@www.baidu.com:88/path?query#fagment");
    bool res = uri.IsAbsolute();
    ASSERT_FALSE(res);
}
